...
\paragraph{Where Corollary~2 stops, its radius condition is tight.} It is a \emph{retention} result, silent
outside that radius, and the question it leaves is whether the radius is sharp.
