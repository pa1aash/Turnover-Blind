...
bounded scorecaster \citep[Thm~1, Prop.~2]{angelopoulos2023pid}, generalizing the running-error
...
threshold) sits in the first of them. Those four vocabularies are where this paper's claim and
