...
The harness, its frozen configuration, the \texttt{results/} files behind every figure and
table, the generators that read them, and this project's audit trail are at
