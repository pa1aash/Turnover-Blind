...
%
% RE-MEASURED, S5 WAVE 5, BOTH VENUE OPTIONS, three passes + bibtex, artefacts deleted
% first.  This supersedes every measurement block below it.
...
%
% THE URL IS VERIFIED, NOT ASSUMED.  Checked headlessly on 2026-08-21 with
%   curl -s https://api.github.com/repos/pa1aash/Turnover-Blind
% which returned HTTP 200 with "private": false, "visibility": "public",
% "default_branch": "main".  No browser was used and none is configured.
%
% IT IS GUARDED BY \if@anonymous, WHICH IS WHAT O65 ACTUALLY ASKED FOR.  A bare repository
% link under dblblindworkshop is a de-anonymisation and a desk-reject risk, the same defect
% class as the pdfauthor leak S5's adversarial critic found.  \if@anonymous is the style
% file's own flag (neurips_2026.sty:78 declares it TRUE; only sglblindworkshop and
% nonanonymous clear it), so this tracks the venue switch automatically and needs no second
% thing to remember.  UNDER dblblindworkshop THIS SECTION DOES NOT PRINT AT ALL.
% THE VENUE DECISION IS NOT TOUCHED BY THIS BLOCK.  It is correct under either option.
%
...
\url{https://github.com/pa1aash/Turnover-Blind}.
\fi
\makeatother
