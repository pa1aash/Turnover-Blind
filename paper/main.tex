...
% S12 SUB-SESSION E: a fifth float (the body results table) forced the same choice one more
% notch, for the same reason and under the same constraint -- white space around floats only,
% the venue's style file untouched. Six body lines of overage remained after every non-protected
% content trim this session made (research/S12/patch-log.json); this closes it or narrows it
% without touching a single word of body prose.
