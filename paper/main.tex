...
threshold inside an admissible radius. The claim was acted on; the smoothing readout's
...
$\alpha = 0.1$: the coverage guarantee fails, not just its rate. The edge belongs to the
