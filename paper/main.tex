...
threshold inside an admissible radius. The claim was acted on in that paper's own baselines;
the placement of a smoother in that slot and the corollary's derivation are credited by name.
