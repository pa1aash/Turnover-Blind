...
delivers its full $\pm b$. Every figure is the \emph{primary} regime's, defined in
...
\begin{figure}[tb]
  ...
  a symlog axis whose linear zone is $|\tau - \tau^{\star}| \le 10^{-3}$, each tick
  carrying the $\tau$ it marks. The grey band spans the widest covering width to the
