...
adjustment of weight $w$ leaves it; Table~\ref{tab:forfeit} prices that departure. For $w = 0.99$ and
...
\begin{figure}[tb]
  ...
  scorecaster's edge is located; the other four are bracketed. Appendix~\ref{app:support} gives the
...
the other four bracketed. \textbf{Here $\sup_x r_t(x) = b$ and $\hat{q} \equiv 0$, so
...
returns $1.000000$ or $0.000000$ by the tie rule. Every other verdict is convention-free.
