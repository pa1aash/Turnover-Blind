...
the others one-sided. \textbf{Here $\sup_x r_t(x) = b$ and $\hat{q} \equiv 0$, so
...
$(\tau^{\star},\infty)$, open at the left. \textbf{The endpoint is where the adversary's
...
primary regime covers, while scoring that play strictly returns $0.000000$ and scoring it as a
miscoverage returns $1.000000$. Appendix~\ref{app:support} separates the two readings.
