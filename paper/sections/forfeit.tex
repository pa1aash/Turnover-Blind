...
forfeit of the rate by post-processing. Elsewhere it stays sufficient only, and now measurably so:
under the tangent integrator no finite width forfeits coverage, and at $\hat{q} \equiv +b/2$
Corollary~2 permits radius $0$ and $0$ is what (\ref{eq:boundaries}) permits as well. That
asymmetry makes ``tight'' a located claim.
