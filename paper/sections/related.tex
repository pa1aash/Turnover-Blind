...
around the deployed threshold) sits in the first of them. Table~\ref{tab:bridge} in Appendix~\ref{app:bridge} names them and what each
contributes. \textbf{What is conceded, by name.}
