...
% "The row gives what each contributes").  What survives, still a complete sentence
% pair: that the admissible set sits in the first of the four vocabularies, and a pointer
% to Table~\ref{tab:bridge} that still names the appendix explicitly (App.~\ref{app:bridge})
% rather than relying on the reader to follow the cross-reference blind.
%
...
Four vocabularies name one quantity; Table~\ref{tab:bridge} (App.~\ref{app:bridge}) names all four. \textbf{What is conceded, by name.}
