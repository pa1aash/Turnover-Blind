...
Theorem~1 permits scorecasters $b/2$ either side of null, predictable but not constant in $t$.
The adversary is specified, not
...
included. Every number in Table~\ref{tab:forfeit} is measured against the one adversary above;
