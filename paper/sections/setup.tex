...
w\tilde{q}_t$ \citep{garleanu2013dynamic}, which \citet{godahewa2025stability} publish as
...
Appendix~\ref{sec:related} names ten across four vocabularies, so a fresh one is used here, for one
reading only.
