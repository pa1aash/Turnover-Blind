...
Conformal PID \citep{angelopoulos2023pid} manipulates the threshold on the score scale, where
adaptive conformal inference \citep{gibbs2021aci} and DtACI \citep{gibbs2024dtaci} move the level,
\begin{equation}
