...
perturbation of the deployed threshold does not. They share a bibliography, so this is ordinary
...
\paragraph{Claim and refutation, both in print.} Conformal PID \citep{angelopoulos2023pid}
...
\paragraph{Where that refutation stops.} Corollary~2 is a \emph{retention} result, silent
