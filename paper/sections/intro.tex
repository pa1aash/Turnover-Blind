...
An online conformal method \citep{angelopoulos2021gentle} emits a threshold before each
observation and moves it. Forecast
...
the null scorecaster. Past it long-run coverage fails, not merely the $|E_T|$ rate: the
published sufficient condition is necessary there. Appendix~\ref{sec:related} sets both claims beside four
